...
class EmergencyInfoVetPage extends StatefulWidget {
  const EmergencyInfoVetPage({super.key});

  @override
  State<EmergencyInfoVetPage> createState() => _EmergencyInfoVetPageState();
}

class _EmergencyInfoVetPageState extends State<EmergencyInfoVetPage> {
  int _visitType = 1; // 0 = Clinic, 1 = Home Visit
            ...
            children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('Dr. Charan', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () => context.push('/emergency-tracking'),
